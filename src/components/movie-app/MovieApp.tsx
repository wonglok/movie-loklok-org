...
export function MovieApp() {
  ...
  const handleGenerateReferenceVideo = async (id: string) => {
    ...
    try {
      ...
      const prompt = `Close-up portrait shot of the character facing the camera. The character says: "Hi! I'm ${char.name}!". Character's Description: ${char.description}. The camera stays static, focused on the character's face with natural expression and lip-sync to the spoken words. Simple neutral background. Language & Tone: ${language}. No background music`;
