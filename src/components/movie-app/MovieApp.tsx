          ...
          <div className="relative mb-6">
            <div className="inline-flex w-full justify-between">
              ...
              <button
                ...
                className="p-2 text-neutral-500 hover:text-white transition-colors rounded-xl hover:bg-neutral-800"
                title="Settings"
              >
                <svg
                  className="w-6 h-6"
            ...
            {projectMenuOpen && (
              <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-64 bg-neutral-900 border border-neutral-600 rounded-xl shadow-xl z-50 py-2">
                {projects.map((p) => (
                  <button
                    key={p.id}
                ...
                <div className="border-t border-neutral-600 mt-1 pt-1">
                  ...
                  <button
                    ...
                    className="w-full text-left px-4 py-2 text-sm text-blue-400 hover:bg-blue-800 transition-colors"
                  >
                    <svg
                      className="w-4 h-4 inline-block mr-1"
                      fill="none"
